...
(e.g. -o "--myflag myargument",-b)`)
	...
	flag.Usage = func() {
		...
		fmt.Println("Usage: exeiac (exec|smart-exec) MODULE_ACTION (BRICK_PATH|BRICK_NAME) [OPTION...]")
		fmt.Println()
		fmt.Println("ACTION:")
		...
		fmt.Println("  help: display this help or the brick's selected module help")
		...
		fmt.Println("  exec: execute all bricks output needed and the module action specifief for each brick specified")
		fmt.Println("  smart-exec: execute all bricks output needed and the module action specifief for each brick specified and their trigerred bricks")
		fmt.Println("MODULE_ACTION:")
		fmt.Println("  ... a module action as lay, remove, plan, output, init... or anything else you have coded in your module")
		fmt.Println()
		fmt.Println("OPTION:")
		flag.PrintDefaults()
	}
